    ...
    <div className="container">
      <div className="flex flex-wrap">
        <div className="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
          <h2 className="mb-5 text-4xl font-bold text-white">Freddy Muleya</h2>
          <h3 className="mb-2 text-2xl font-bold">Contact me</h3>
          <p>freddymuleya16@gmail.com</p>
          <p>Midrand</p>
          <p>South Africa</p>
        </div>
        <div className="mb-12 w-full px-4 md:w-1/3">
          <h3 className="mb-5 text-xl font-semibold text-white">Software</h3>
          <ul className="text-slate-300">
            <li>
              <a href="#" className="mb-3 inline-block text-base hover:text-primary">Website</a>
            </li>
            <li>
              <a href="#" className="mb-3 inline-block text-base hover:text-primary">IOS Applications</a>
            </li>
            <li>
              <a href="#" className="mb-3 inline-block text-base hover:text-primary">Android Applications</a>
            </li>
            <li>
              <a href="#" className="mb-3 inline-block text-base hover:text-primary">Web Applications</a>
            </li>
          </ul>
        </div>
        <div className="mb-12 w-full px-4 md:w-1/3">
          ...
          <ul className="text-slate-300">
            ...
            {/* <li>
              <a href="#clients" className="mb-3 inline-block text-base hover:text-primary">Clients</a>
            </li> */}
            {/* <li>
              <a href="#blog" className="mb-3 inline-block text-base hover:text-primary">Blog</a>
            </li> */}
            <li>
              <a href="#contact" className="mb-3 inline-block text-base hover:text-primary">Contact</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="w-full border-t border-slate-700 pt-10">
        ...
        <p className="text-center text-xs font-medium text-slate-500">
          Made with <span className="text-pink-500">❤️</span> by  <a href="https://instagram.com/freddy_muleya" target="_blank" className="font-bold text-primary">Freddy Muleya</a>, Using 
