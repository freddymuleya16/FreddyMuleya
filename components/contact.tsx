    ...
    <div className="container">
      <div className="w-full px-4">
        <div className="mx-auto mb-16 max-w-xl text-center">
          ...
          <p className="text-md font-medium text-secondary md:text-lg">Let&apos;s embark on this journey together and create something extraordinary!</p>
        </div>
      </div>
      ...
      <form>
        <div className="w-full lg:mx-auto lg:w-2/3">
          ...
          <div className="w-full px-4">
            <button className="w-full rounded-full bg-primary py-3 px-8 text-base font-semibold text-white transition duration-500 hover:opacity-80 hover:shadow-lg">Send</button>
          </div>
        </div>
      </form>
    </div>
